...
Pl9 ==
    /\ 0..n - 1 \subseteq DOMAIN tab_out /\ 0 \leq c /\ c < n - 1 /\ Enum(n, tab_out) = Enum(n, tab)
    /\ Forall({ Forall({tab_out[l] \leq tab_out[k] : l \in 0..k }) : k \in n - c..n - 1}) 
    /\ 0 \leq d /\ d < n - c - 1 /\ Forall({ tab_out[k] \leq tab_out[d] : k \in 0..d})
Pl10 ==
    /\ 0..n - 1 \subseteq DOMAIN tab_out /\ 0 \leq c /\ c < n - 1 /\ Enum(n, tab_out) = Enum(n, tab)
    /\ Forall({ Forall({tab_out[l] \leq tab_out[k] : l \in 0..k }) : k \in n - c..n - 1}) 
    /\ 0 \leq d /\ d < n - c - 1 /\ Forall({ tab_out[k] \leq tab_out[d] : k \in 0..d})
...
Pl13 ==
    /\ 0..n - 1 \subseteq DOMAIN tab_out /\ 0 \leq c /\ c < n - 1 /\ Enum(n, tab_out) = Enum(n, tab)
    /\ Forall({ Forall({tab_out[l] \leq tab_out[k] : l \in 0..k }) : k \in n - c..n - 1}) 
    /\ 0 \leq d /\ d < n - c - 1/\ Forall({ tab_out[k] \leq tab_out[d + 1] : k \in 0..d + 1})
Pl14 ==
    /\ 0..n - 1 \subseteq DOMAIN tab_out /\ 0 \leq c /\ c < n - 1 /\ Enum(n, tab_out) = Enum(n, tab)
    /\ Forall({ Forall({tab_out[l] \leq tab_out[k] : l \in 0..k }) : k \in n - c..n - 1}) 
    /\ 0 \leq d /\ d < n - c - 1/\ Forall({ tab_out[k] \leq tab_out[d + 1] : k \in 0..d + 1})
...
Pl16 ==
    /\ 0..n - 1 \subseteq DOMAIN tab_out /\ 0 \leq c /\ c < n - 1 /\ Enum(n, tab_out) = Enum(n, tab)
    /\ Forall({ Forall({tab_out[l] \leq tab_out[k] : l \in 0..k }) : k \in n - c..n - 1}) 
    /\ 0 \leq d /\ d \leq n - c - 1/\ Forall({ tab_out[k] \leq tab_out[d] : k \in 0..d})
Pl17 ==
    /\ 0..n - 1 \subseteq DOMAIN tab_out /\ 0 \leq c /\ c < n - 1 /\ Enum(n, tab_out) = Enum(n, tab)
...
\* Last modified Wed Apr 29 21:19:44 CEST 2020 by alexandre
